 ...
 function handleImage(e){
  ...
  return (
    <div className="w-full min-h-[100vh] bg-[#f0efe7] pt-[100px] flex items-center lg:items-start justify-center gap-[20px] px-[20px] flex-col lg:flex-row relative pb-[50px]">
      ...
      {uploadPost &&
 <div className='w-full h-full bg-black fixed top-0 z-[100] left-0 opacity-[0.6]'>
       </div> }
          ...
          <div className='w-full h-[200px] flex flex-col'>
            ...
            <button
  className="w-[100px] h-[50px] rounded-full bg-[#24b2ff] mt-[40px] text-white" disabled={posting}
...
>{posting?"posting...":"Post"}
      ...
      <div className="w-full lg:w-[50%] min-h-[200px] bg-[#f0efe7] shadow-lg rounded-lg p-[10px] relative ">
        <div className="w-ful h-[120px] bg-white shadow-lg rounded-lg flex items-center justify-center gap-[10px">
          <div className='w-[70px] h-[70px] rounded-full overflow-hidden flex items-center justify-center cursor-pointer'>
                      <img src={userData.profileImage || dp} alt="" className='h-full'/>
                  </div>
      ...
      <div className="w-full lg:w-[25%] min-h-[200px] bg-[white] shadow-lg rounded-lg p-[10px] relative "></div>
    </div>
  );
}
